...
function apiAxios (method, url, params, success, failure) {
  ...
  axios({
    ...
    headers: url.type === 'json' ? { 'Content-Type':'application/json; charset=UTF-8'} : 
      url.type === 'formData' ? { 'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8'} : {'Content-Type': 'multipart/form-data; charset=UTF-8'},
  ...
  .then(function (res) {
    ...
    if(res.data.code == 0){
      ...
      localStorage.clear();
      CommomObj.$comfirm3(res.data.msg ? res.data.msg : res.data.message,function () {
